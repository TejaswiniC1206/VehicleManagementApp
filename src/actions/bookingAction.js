...
export const fetchBookingByCustomer = (payload) => {
    return dispatch => {
        fetch('http://localhost:8081/api/v1/bookingsByCustomer/'+payload)
        .then(res => {
            if (res.status === 200) {
                return res.json();
            } else {
...
export const fetchBookingByVehicle = (payload) => {
    return dispatch => {
        fetch('http://localhost:8081/api/v1/bookingsByVehicle/'+payload)
        .then(res => {
            if (res.status === 200) {
                return res.json();
            } else {
...
export const fetchBookingByDate = (payload) => {
    return dispatch => {
        fetch('http://localhost:8081/api/v1/bookingsByDate/'+payload)
        .then(res => {
            if (res.status === 200) {
                return res.json();
            } else {
