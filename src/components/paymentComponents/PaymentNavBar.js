...
import { fetchPayments,fetchPaymentByBooking,fetchPaymentByVehicle } from "../../actions/paymentAction"
...
const options = ['Search', 'Vehicle number', 'Booking ID'];
...
export const PaymentNavBar = () => {
    ...
    const handleClick = () => {
        switch (options[selectedIndex]) {
            ...
            case "Payment By Vehicles":
                {
                    console.info(`You clicked ${options[selectedIndex]}`);
                    searchText && dispatch(fetchPaymentByVehicle(searchText));
                    setSearchText("")
                    break;
                }
            case "Payment By Booking":
                {
                    console.info(`You clicked ${options[selectedIndex]}`);
                    searchText && dispatch(fetchPaymentByBooking(searchText));
                    setSearchText("")
                    break;
                }
            default:
