    ...
    >
      <List>
        ...
        <ListItem><ListItemIcon><EmojiTransportationIcon /></ListItemIcon>
          <Link to='/viewBooking' style={{ textDecoration: 'none' }}><ListItemText primary='Bookings' /></Link>
        </ListItem>
        ...
        <Link to='/viewPayment' style={{ textDecoration: 'none' }}><ListItemText primary='Payments' /></Link>
        </ListItem>
